...
num_steps   = 2500000                   # number of integration steps to run
...
simulation.reporters.append(simtk.openmm.app.dcdreporter.DCDReporter(file_naming+'.npt_equilib.dcd',trj_freq))
simulation.reporters.append(simtk.openmm.app.statedatareporter.StateDataReporter(file_naming+'.npt_equilib.out',data_freq,step=True,potentialEnergy=True,kineticEnergy=True,temperature=True,volume=True,density=True,speed=True))
...
simulation.saveCheckpoint(file_naming+'.npt_equilib.chkpt')
simulation.saveState(file_naming+'.npt_equilib.stt')
